...
public class FileStorageService {
	...
	public FileStorageService(FileStorageProperties fileStorageProperties) {
		...
		this.productFileStorageLocation = Paths.get(fileStorageProperties.getUploadDir())
				.resolve(fileStorageProperties.getProductFileUploadUrl()).toAbsolutePath().normalize();
	...
	public String storeFile(MultipartFile file, String[] paths) {
		// Normalize file name
				String fileName = StringUtils.cleanPath(file.getOriginalFilename());
	...
	public Resource loadFileAsResource(String fileName, String[] paths) {
		try {
			Path filePath = this.fileStorageLocation;
			if (null != paths) {
				for (String path : paths) {
